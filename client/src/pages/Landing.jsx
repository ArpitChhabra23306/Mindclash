    ...
    return (
        <div style={{ minHeight: '100vh', background: '#fff' }}>
            ...
            <nav className="navbar" style={{ maxWidth: '1200px', margin: '0 auto' }}>
                <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
                    <div style={{
                        ...
                        <span style={{ fontSize: '16px', fontWeight: 'bold', color: 'white' }}>MC</span>
                    </div>
                    <span style={{ fontSize: '20px', fontWeight: 'bold', color: '#171717' }}>Mindclash</span>
                </Link>
                ...
                <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
                    ...
                    >
                        ...
                        <h1 style={{
                            ...
                            Welcome to
                            <span className="text-gradient" style={{ display: 'block', marginTop: '8px' }}>Mindclash</span>
                        </h1>
                ...
                <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                    ...
                    >
                        <h2 style={{ fontSize: 'clamp(1.75rem, 4vw, 2.25rem)', fontWeight: '700', color: '#171717', marginBottom: '12px' }}>
                            Why <span className="text-gradient">Mindclash</span>?
                        </h2>
            ...
            <footer style={{
                ...
                <p>Made with ❤️ by Mindclash Team • © 2024</p>
            </footer>
        </div>
    );
};
